...
C = datam100.iloc[1, 1]  # Wert von Zeile 2, Spalte 2
...
for i in range(2, 15):
    ...
    for filename in os.listdir(source_path):
        ...
        if filename.endswith('.trc'):
            ...
            # Überprüfen, ob C, D oder E im Dateinamen enthalten ist
            if 'C' in filename or 'D' in filename or 'E' in filename:
                ...
                print(f"Dateiname {filename} enthält nicht C, D oder E.")  # Debugging-Ausgabe
